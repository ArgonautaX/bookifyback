...
/**
 * Clase encargada de poblar la base de datos con datos de prueba al iniciar la aplicación.
...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Categoria cienciaFiccion = categoriaRepository.save(Categoria.builder().nombre("Ciencia Ficción").build());
        Categoria programacion = categoriaRepository.save(Categoria.builder().nombre("Programación").build());
        Categoria desarrolloPersonal = categoriaRepository.save(Categoria.builder().nombre("Desarrollo Personal").build());
        ...
        Libro elSenorDeLosAnillos = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/8743161-L.jpg",
                tolkien, fantasia
        );
        ...
        Libro elHobbit = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/8405096-L.jpg",
                tolkien, fantasia
        );
        ...
        Libro harryPotter = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/10523456-L.jpg",
                rowling, fantasia
        );
        ...
        Libro nombreDelViento = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/9917447-L.jpg",
                rothfuss, fantasia
        );
        ...
        Libro milNovecientosOchentaYCuatro = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/9862822-L.jpg",
        ...
        Libro elMiticoHombresMes = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/6383065-L.jpg",
                brooks, programacion
        );
        ...
        Libro habitosAtomicos = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/12547726-L.jpg",
        ...
        Libro padrePadreRico = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/8388630-L.jpg",
        ...
        Libro elCodigoDaVinci = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/8271673-L.jpg",
                brown, thriller
        );
        ...
        Libro angelesYDemonios = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/10202868-L.jpg",
                brown, thriller
        );
        ...
        Libro elResplandor = crearLibro(
                ...
                new BigDecimal("50.00"), "EPUB",
                "https://covers.openlibrary.org/b/id/12330752-L.jpg",
                king, thriller
        );
        ...
        Libro it = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/8267272-L.jpg",
                king, thriller
        );
        ...
        Libro diezNegritos = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/8044737-L.jpg",
                christie, thriller
        );
        ...
        Libro narnia = crearLibro(
                ...
                new BigDecimal("40.00"), "PDF",
                "https://covers.openlibrary.org/b/id/8230239-L.jpg",
                lewis, fantasia
        );
        ...
        Libro americanGods = crearLibro(
                ...
                new BigDecimal("55.00"), "EPUB",
                "https://covers.openlibrary.org/b/id/8408930-L.jpg",
                gaiman, fantasia
        );
        ...
        Libro nacidosBruma = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/12970425-L.jpg",
                sanderson, fantasia
        );
        ...
        Libro fundacion = crearLibro(
                ...
                new BigDecimal("45.00"), "PDF",
                "https://covers.openlibrary.org/b/id/10543594-L.jpg",
        ...
        Libro dune = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/12932158-L.jpg",
        ...
        Libro guiaGalactica = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/8254807-L.jpg",
        ...
        Libro sapiens = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/10313835-L.jpg",
        ...
        Libro comoGanarAmigos = crearLibro(
                ...
                new BigDecimal("42.00"), "EPUB",
                "https://covers.openlibrary.org/b/id/8230554-L.jpg",
        ...
        Libro cienAnos = crearLibro(
                ...
                new BigDecimal("50.00"), "EPUB",
                "https://covers.openlibrary.org/b/id/10433299-L.jpg",
                marquez, clasicos
        );
        ...
        Libro rebelionGranja = crearLibro(
                ...
                "https://covers.openlibrary.org/b/id/12538183-L.jpg",
                orwell, clasicos
        );
